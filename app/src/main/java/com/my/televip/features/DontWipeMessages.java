...
public class DontWipeMessages {
    ...
    //
    //  Smart detection handles BOTH clients:
    //  • Official Telegram  → currentTimeString is String/CharSequence
    //  • NagramX/Nekogram   → currentTimeString is SpannableStringBuilder
    //
    //  Tries AutomationResolver field name first, falls back to raw
    //  "currentTimeString" for NagramX where it is not obfuscated.
    // ══════════════════════════════════════════════════════════════
    ...
    //  The server can no longer serve deleted media files, so
    //  telling Telegram "canDownloadMedia = 0" avoids failed requests.
    // ══════════════════════════════════════════════════════════════
